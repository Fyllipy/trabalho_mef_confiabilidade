...
| --- | --- | --- | --- | --- |
| Média do Topo (Uz) | -2.012002e-03 | -1.989437e-03 | 2.256487e-05 | 1.1342 % |
...
| --- | --- |
| Erro Absoluto Médio (MAE) | 2.256487e-05 |
| Raiz do Erro Quadrático Médio (RMSE) | 2.256487e-05 |
| Erro Relativo em Norma L2 (%) | 1.1342 % |
| Erro Relativo de Pico (%) | 1.1342 % |
...
O deslocamento axial médio no topo obtido pelo solver próprio foi de -2.012002e-03 mm, enquanto a referência do Abaqus retornou -1.989437e-03 mm, resultando em um erro relativo de 1.1342%. A concordância entre as soluções atesta a corretude da formulação de casca linear estática.